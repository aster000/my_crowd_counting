...
class ShanghaiA_PaDNet(data.Dataset):
    def __init__(self, args, _type, mode='train'):
    ...
    def load_train_data(self):
        ...
        if self.type == 'l1':
            ...
            s = 0
            e = 5400
        self.image_name_list = dataset['image_name_list'][s:e]
        self.image_pos = dataset['image_pos'][s:e]
